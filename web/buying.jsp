<%-- 
    Document   : buying
    Created on : 02.Oca.2021, 19:56:22
    Author     : sarik
--%>
                    ...
                    <div id="main">
                        ...
                        <section id="ContactUs">
                            <div class="container contact-container">
                                <h3 class="contact-title">Alış İşlemleri</h3>
                                <div class="contact-outer-wrapper">
                                    <div class="form-wrap">
                                        <form action="ServletBuying" method="POST">
                                            <div class="fname floating-label">
                                                <input type="text" required class="floating-input" name="urunAdi" />
                                                <label for="title">Ürün İsmi</label>
                                            </div>
                                            <br>
                                            <div class="floating-label">
                                                <input type="number" step="any" required class="floating-input" name="ucret" />
                                            ...
                                            <div class="submit-btn">
                                                <button type="submit">Alımı Başlat</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
